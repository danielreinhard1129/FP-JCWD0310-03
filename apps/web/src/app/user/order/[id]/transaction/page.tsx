      ...
      <div className='flex flex-col gap-4 container bg-mythemes-grey px-6 min-h-screen py-6'>
        <div className='flex flex-col gap-4 p-6 rounded-xl shadow-lg bg-white'>
          ...
          <div className='flex flex-col'>
            ...
            <p className='mx-auto text-sm font-bold text-mythemes-maingreen'>{data?.invoiceNumber}</p>
            <p className='mx-auto text-xs font-bold text-gray-500'>Due on: {formattedDate}</p>
          </div>
          <div className='flex flex-col text-gray-700'>
            ...
            <div className='flex justify-between'>
              ...
              <p className='text-sm'> {data?.order.pickupOrder.user.fullName}</p>
            </div>
            <div className='flex justify-between'>
          ...
          <div>
            <div className='flex flex-col'>
              <div className='flex justify-between'>
                ...
                <p className='text-sm font-semibold'>IDR {data?.order.pickupOrder.pickupPrice}</p>
              </div>
              <div className='flex justify-between'>
              ...
              <div className='pl-4 flex justify-between'>
                <p className='text-xs font-medium my-auto'>{data?.order.weight}KG</p>
                <p className='text-xs font-medium my-auto'>x</p>
                <p className='text-xs font-medium my-auto'>IDR 6000/KG</p>
                <p className='text-sm font-semibold'>IDR {data?.order.laundryPrice}</p>
              </div>
              <div className='flex justify-between'>
                <p className='text-sm font-semibold'>Amount</p>
                <p className='text-sm font-bold text-mythemes-maingreen'>IDR {data?.amount}</p>
              </div>
            </div>
          </div>
          <Separator />
          <div className='flex flex-col'>
            <div className='flex'>
              ...
              <p className='text-sm w-2/4 font-bold text-mythemes-maingreen'>{paymentMethode}</p>
            </div>
            <div className='flex flex-col'>
