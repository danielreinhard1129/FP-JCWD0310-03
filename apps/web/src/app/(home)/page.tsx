    ...
    <main>
      <div className="bg-hero bg-cover bg-center bg w-full md:h-screen">
        <div className="container flex flex-col place-content-center h-screen gap-6">
          <div className="font-black md:text-6xl text-4xl text-white text-center text-pretty text-background mt-72 mb-44 ">
            {' '}
            We Handle Your{' '}
          ...
          <div className="flex justify-center">
            <Button className=" mx-auto md:text-xl text-md bg-white text-mythemes-maingreen rounded-xl font-bold hover:bg-mythemes-secondarygreen">
              Get Started
            </Button>
          </div>
          {/* </div> */}
