  ...
  return (
    <div className="container flex flex-col gap-5 p-6 bg-[#f4f4f4]">
      ...
      <div className="flex gap-5">
        <div className="p-6 w-1/3 bg-white rounded-3xl">
          <p className="text-2xl text-gray-500 mb-3">Total Revenue</p>
          <p className="text-4xl font-semibold text-gray-700">
            {formatCurrency(Number(data?.totalIncome))}
          </p>
        </div>
        <div className="p-6 w-1/3 bg-white rounded-3xl">
          <p className="text-2xl text-gray-500 mb-3">Total Transaction</p>
          <p className="text-4xl font-semibold text-gray-700">
            {data?.totalTransaction}
          </p>
        </div>
        <div className="p-6 w-1/3 bg-white rounded-3xl">
          <p className="text-2xl text-gray-500 mb-3">Total Weight</p>
          <p className="text-4xl font-semibold text-gray-700">
            {data?.totalWeight} kg
          </p>
        </div>
      ...
      <div>
        <Table className="text-xs bg-white rounded-xl text-stone-800">
          <TableHeader>
            <TableRow>
