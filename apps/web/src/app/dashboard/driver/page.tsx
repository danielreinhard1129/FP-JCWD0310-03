      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex gap-3">
          <Link
            ...
            href={'/dashboard/driver/pickup/request'}
          >
            <h1 className="mx-auto my-auto font-bold text-gray-600">Pickup</h1>
          </Link>
          <Link
            className="flex w-1/2 h-16 bg-mythemes-taubmans rounded-xl shadow-md"
            href={'/dashboard/driver/delivery/request'}
          >
            <h1 className="mx-auto my-auto font-bold text-gray-600">
              Delivery
            </h1>
          </Link>
        </div>
