...
export default function WorkerWasherAuthGuard(Component: any) {
  return function IsAuth(props: any) {
    ...
    useEffect(() => {
      ...
      if (user?.employee.station !== EmployeeStation.WASHING && user?.employee.station === EmployeeStation.IRONING && !isLoading){
        toast.error("You don't have permission to access this page.");
        redirect('/dashboard/worker');
      }
      if (user?.employee.station !== EmployeeStation.WASHING && user?.employee.station === EmployeeStation.PACKING && !isLoading){
        toast.error("You don't have permission to access this page.");
        redirect('/dashboard/worker');
      }
